...
1. [Teleport](teleport.py)
    ...
    ![teleport](docs/_static/teleport.png)
...
1. [Arithmetic](arithmetic.py)
    ...
    ![arithmetic](docs/_static/arithmetic.png)
...
1. [Scratch qubit](scratch_qubit.py)
    ...
    ![scratch qubit](docs/_static/scratch_qubit.png)
...
1. [Amplitude amplification](amplitude_amplification.py)
    ...
    ![amplitude amplification](docs/_static/amplitude_amplification.png)
...
1. [Quantum Fourier Transform](quantum_fourier_transform.py)
    ...
    ![QFT](./docs/_static/quantum_fourier_transform.png)
